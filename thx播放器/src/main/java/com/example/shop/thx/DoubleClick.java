 ...
 *
 */
public abstract class DoubleClick implements View.OnTouchListener {
    /**
     * 上次 onTouch 发生的时间
     */
    ...
    protected abstract View getMainLoopHandler();
    ...
    protected abstract void postTaskInUIThread(Runnable run, int multiTouchInterval);
